...
public final class RecordAccumulator {
     ...
     */
    public RecordAppendResult append(TopicPartition tp, long offset, byte[] key, byte[] value, Callback callback, long maxTimeToBlock) throws InterruptedException {
        ...
        try {
            ...
            synchronized (dq) {
                ...
                if (last != null) {
                    FutureRecordMetadata future = last.tryAppend(offset, key, value, callback, time.milliseconds());
                    if (future != null)
            ...
            synchronized (dq) {
                ...
                FutureRecordMetadata future = Utils.notNull(batch.tryAppend(offset, key, value, callback, time.milliseconds()));
